...
from app.api.routers import user, group, venv, venv_package, repository, credential, inventory
...
router.include_router(venv_package.router, prefix="/venv_package", tags=["venv_package"])
